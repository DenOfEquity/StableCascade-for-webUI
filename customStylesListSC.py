...
styles_list = [
    ...
    (
    "SoteDiffusion",
    "newest, extremely aesthetic, best quality, {prompt}",
    ", very displeasing, worst quality, monochrome, sketch, realistic, oldest, loli"
    ),
    (
    "SoteDiffusion v2",
    "{prompt}, very aesthetic, best quality, newest",
